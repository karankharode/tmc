...
const Color darkRed_primary = Color(0xff670202);
...
// loginPage
const Color login_blue = Colors.blue;

// dashboard

const Color tableDarkColor = Color(0xffF0F2F7);
const Color statBoxColor = Color(0xffF8F8F8);

// notification
const Color notifierColor = Color(0xff4044D4);
